      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    gradient: const LinearGradient(
                      colors: [Color(0xFFEFF6FF), AppColors.englishIconBg],
                ...
                if (children.isEmpty) {
                  return Container(
                    ...
                    child: const Column(
                      ...
                      children: [
                        Icon(Icons.family_restroom_rounded, size: 40, color: AppColors.textMuted),
                        SizedBox(height: 10),
                        Text(
                            ...
                            ...children.map((child) {
                              ...
                              return Padding(
                                ...
                                child: ChoiceChip(
                                  avatar: CircleAvatar(
                                    radius: 10,
                                    backgroundColor: isSelected ? Colors.white24 : AppColors.divider,
                                    child: Icon(
                                      Icons.person,
                                      size: 12,
            ...
            homeworkAsync.when(
              data: (allHomework) {
                final filteredHomework = ChildScope.homeworkFor(allHomework, selectedChild);
                ...
                if (filteredHomework.isEmpty) {
                  return Container(
                    ...
                    child: Center(
                      child: Column(
                        children: [
                          const Icon(Icons.assignment_turned_in_outlined, size: 32, color: AppColors.textMuted),
                          const SizedBox(height: 8),
                          Text(
                            selectedChild != null
            ...
            announcementsAsync.when(
              data: (allNotices) {
                final filteredNotices = ChildScope.announcementsFor(allNotices, selectedChild);
    ...
    return Container(
      ...
      child: Row(
        children: [
          const CircleAvatar(
            radius: 22,
            backgroundColor: AppColors.scienceIconBg,
      ...
      children: [
        ...
        Expanded(
          child: _buildStatTile(
            ...
            iconBg: unreadNotifsCount > 0 ? AppColors.mathIconBg : AppColors.surfaceElevated,
            ...
            Row(
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: isOverdue ? AppColors.mathIconBg : AppColors.surfaceElevated,
            ...
            Row(
              children: [
                Container(
                  padding: const EdgeInsets.symmetric(horizontal: 7, vertical: 2),
                  decoration: BoxDecoration(
                    color: isUrgent ? AppColors.mathIconBg : const Color(0xFFEFF6FF),
                    borderRadius: BorderRadius.circular(4),
                  ),
                  child: Text(
                    notice.priority,
