            ...
            data: (list) {
              final filtered = list.where((item) {
                ...
                if (_searchQuery.isNotEmpty) {
                  ...
                  final matchClass = item.classroomName.toLowerCase().contains(q);
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      item.classroomName.isNotEmpty ? item.classroomName : item.subject,
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  children: [
                    _buildDetailRow(Icons.meeting_room_outlined, 'Class', item.classroomName.isNotEmpty ? item.classroomName : 'Assigned Class'),
                    const Divider(height: 16, color: AppColors.border),
                    _buildDetailRow(Icons.person_outline, 'Assigned By', item.assignedByName.isNotEmpty ? item.assignedByName : 'Teacher'),
                    const Divider(height: 16, color: AppColors.border),
                    _buildDetailRow(Icons.event_available, 'Assigned Date', formattedAssigned),
                    const Divider(height: 16, color: AppColors.border),
                    _buildDetailRow(Icons.event_busy, 'Due Date', formattedDue),
                  ],
                ),
              ),
              if (item.description.isNotEmpty) ...[
