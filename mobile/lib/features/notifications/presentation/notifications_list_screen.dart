...
class _NotificationsListScreenState extends ConsumerState<NotificationsListScreen> {
  ...
  Widget _buildNotificationCard(BuildContext context, NotificationModel notification) {
    ...
    final iconColor = isHomework ? const Color(0xFFD97706) : AppColors.primary;
    final iconBg = isHomework ? const Color(0xFFFEF3C7) : const Color(0xFFEFF6FF);
                  ...
                  Row(
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: isHomework ? const Color(0xFFFEF3C7) : const Color(0xFFEFF6FF),
