        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                InfoRow(icon: Icons.account_balance, label: 'Institution', value: schoolName),
                const Divider(height: 16, color: AppColors.border),
                const InfoRow(icon: Icons.location_on_outlined, label: 'Location', value: AppConstants.schoolAddress),
                const Divider(height: 16, color: AppColors.border),
                const InfoRow(icon: Icons.phone_outlined, label: 'Contact', value: AppConstants.schoolPhone),
                const Divider(height: 16, color: AppColors.border),
                const InfoRow(icon: Icons.language_outlined, label: 'Website', value: AppConstants.schoolWebsite),
                const Divider(height: 16, color: AppColors.border),
                const InfoRow(icon: Icons.fingerprint, label: 'Academic Session', value: AppConstants.currentAcademicYear),
              ],
            ),
          ),
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 12),
                InfoRow(icon: Icons.person_outline, label: 'Role', value: roleLabel),
          ...
          SizedBox(
            ...
            child: OutlinedButton.icon(
              ...
              label: const Text('Change password', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14)),
              style: OutlinedButton.styleFrom(
                foregroundColor: AppColors.primary,
